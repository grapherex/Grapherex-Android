...
public class SignalServiceCipher {
    ...
    public OutgoingPushMessage encrypt(SignalProtocolAddress destination,
        ...
        if (unidentifiedAccess.isPresent()) {
            ...
            OutgoingPushMessage outgoingPushMessage = new OutgoingPushMessage(Type.UNIDENTIFIED_SENDER_VALUE, destination.getDeviceId(), remoteRegistrationId, body, online, pushType);
          //  Log.d("SignalServiceCipher", outgoingPushMessage.toString());
            ...
            OutgoingPushMessage outgoingPushMessage = new OutgoingPushMessage(type, destination.getDeviceId(), remoteRegistrationId, body, online, pushType);
           // Log.d("SignalServiceCipher", outgoingPushMessage.toString());
            return outgoingPushMessage;
        }
    }
