...
public class ConversationAdapter
    ...
    public void submitList(@Nullable List<ConversationMessage> pagedList) {
        ...
        if (pagedList != null) {
            List<ConversationMessage> filteredList = Stream.of(pagedList).
                    filter(this::isNotIdentityUpdate).toList();
    ...
    private boolean isNotIdentityUpdate(ConversationMessage message) {
        if (message != null && message.getMessageRecord() != null) {
            return !message.getMessageRecord().isIdentityUpdate();
        } else {
            return true;
        }
    }
