...
public final class ConversationUpdateItem extends FrameLayout
    ...
    private LiveData<CallTextDirection> displayBody;
...
//        }
        ...
        observeDisplayBody(lifecycleOwner, LiveDataUtil.mapDistinct(spannableMessage, input ->
                new CallTextDirection(input, messageRecord.isCallInfo(), messageRecord.isOutgoingCall())));
     ...
     */
    private @NonNull
    LiveData<SpannableString> loading(@NonNull LiveData<SpannableString> string) {
    ...
    private void observeDisplayBody(@NonNull LifecycleOwner lifecycleOwner, @Nullable LiveData<CallTextDirection> displayBody) {
...
//      }
    ...
    private final class UpdateObserver implements Observer<CallTextDirection> {

        @Override
        public void onChanged(CallTextDirection update) {
            setBodyText(update);
        }
    }
