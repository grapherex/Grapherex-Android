...
public abstract class MessageDatabase extends Database implements MmsSmsColumns {
    ...
    ReactionList pruneByAuthor(@NonNull ReactionList reactionList, @NonNull RecipientId recipientId) {
    ...
    private @NonNull
    Optional<ReactionList> getReactions(SQLiteDatabase db, long messageId) {
