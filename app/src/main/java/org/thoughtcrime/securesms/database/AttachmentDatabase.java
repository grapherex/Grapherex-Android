...
public class AttachmentDatabase extends Database {
    ...
    private static final String[] PROJECTION = new String[]{ROW_ID,
            ...
            UPLOAD_TIMESTAMP, CREDENTIONALS, BUCKET};
    ...
    public void copyAttachmentData(@NonNull AttachmentId sourceId, @NonNull AttachmentId destinationId)
        ...
        if (!sourceAttachment.getCredentionals().isEmpty() && !sourceAttachment.getBucket().isEmpty()) {
            contentValues.put(CREDENTIONALS, sourceAttachment.getCredentionals());
            contentValues.put(BUCKET, sourceAttachment.getBucket());
        }
    ...
    public void updateAttachmentAfterUpload(@NonNull AttachmentId id, @NonNull Attachment attachment, long uploadTimestamp) {
        ...
        if (!attachment.getCredentionals().isEmpty()&&!attachment.getBucket().isEmpty()){
