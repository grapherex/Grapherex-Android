...
public class AvatarSelectionBottomSheetDialogFragment extends BottomSheetDialogFragment {
    ...
    private enum SelectionOption {
        CAPTURE("capture", R.string.AvatarSelectionBottomSheetDialogFragment__take_photo, R.drawable.ic_avatar_selection_camera),
        GALLERY("gallery", R.string.AvatarSelectionBottomSheetDialogFragment__choose_from_gallery, R.drawable.ic_avatar_selection_gallery),
        DELETE("delete", R.string.AvatarSelectionBottomSheetDialogFragment__remove_photo, R.drawable.ic_avatar_selection_delete);
