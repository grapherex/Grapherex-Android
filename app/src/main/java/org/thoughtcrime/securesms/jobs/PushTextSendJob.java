...
import org.thoughtcrime.securesms.conversation.IdentityMismatchFailureEvent;
...
public class PushTextSendJob extends PushSendJob {
    ...
    public void onPushSend() throws IOException, NoSuchMessageException, UndeliverableMessageException {
        ...
        try {
            ...
            EventBus.getDefault().post(new IdentityMismatchFailureEvent(record));
            warn(TAG, String.valueOf(record.getDateSent()), "Failure", e);
    ...
    public static class Factory implements Job.Factory<PushTextSendJob> {
        @Override
        public @NonNull
        PushTextSendJob create(@NonNull Parameters parameters, @NonNull Data data) {
