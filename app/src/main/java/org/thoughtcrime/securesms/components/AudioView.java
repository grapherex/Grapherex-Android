...
public final class AudioView extends FrameLayout {
    ...
    @NonNull
    private final View vSeparateArea;
    ...
    public AudioView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            this.vSeparateArea = findViewById(R.id.vSeparateArea);
            ...
            this.isSent = typedArray.getBoolean(R.styleable.AudioView_isSent, false);
            ...
            if (this.vSeparateArea!=null){
                this.vSeparateArea.setBackgroundColor(this.isSent ? context.getColor(R.color.outgoing_background_bubble) : context.getColor(R.color.incoming_background_bubble));
            }
        } finally {
            if (typedArray != null) {
                typedArray.recycle();
    ...
    public void setTint(int foregroundTint) {
        ...
        if (this.duration != null) {
            this.duration.setTextColor(isSent ? getContext().getResources().getColor(R.color.waveformUnplayedBarsColor_sent) :
                    getContext().getResources().getColor(R.color.core_grey_30));
        }
