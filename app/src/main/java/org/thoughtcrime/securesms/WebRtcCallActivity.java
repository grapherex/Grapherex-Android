...
import org.thoughtcrime.securesms.conversation.ui.error.SafetyNumberChangeManager;
...
public class WebRtcCallActivity extends BaseActivity implements SafetyNumberChangeManager.Callback {
    ...
    private SafetyNumberChangeManager safetyNumberChangeManager;
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        safetyNumberChangeManager = new SafetyNumberChangeManager(this);
    ...
    private void handleViewModelEvent(@NonNull WebRtcCallViewModel.Event event) {
        if (event instanceof WebRtcCallViewModel.Event.StartCall) {
            ...
            safetyNumberChangeManager.showForGroupCall(((WebRtcCallViewModel.Event.ShowGroupCallSafetyNumberChange) event).getIdentityRecords());
            return;
        }
    ...
    private void handleUntrustedIdentity(@NonNull WebRtcViewModel event) {
        ...
        safetyNumberChangeManager.showForCall(recipient.getId());
    }
    ...
    public void handleSafetyNumberChangeEvent(@NonNull WebRtcCallViewModel.SafetyNumberChangeEvent safetyNumberChangeEvent) {
        if (Util.hasItems(safetyNumberChangeEvent.getRecipientIds())) {
            if (safetyNumberChangeEvent.isInPipMode()) {
                ...
                safetyNumberChangeManager.showForDuringGroupCall(safetyNumberChangeEvent.getRecipientIds());
            }
        }
    }
