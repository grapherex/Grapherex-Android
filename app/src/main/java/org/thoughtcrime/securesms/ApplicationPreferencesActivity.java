...
//  private static final String PREFERENCE_CATEGORY_USERNAME       = "preference_category_username";
    ...
    private static final String PREFERENCE_CATEGORY_APP_PRIVACY = "preference_category_app_privacy";
...
//        .setOnPreferenceClickListener(new CategoryClickListener(PREFERENCE_CATEGORY_SMS_MMS));
            ...
            this.findPreference(PREFERENCE_CATEGORY_APP_PRIVACY)
                    .setOnPreferenceClickListener(new CategoryClickListener(PREFERENCE_CATEGORY_APP_PRIVACY));
            ...
            this.findPreference(TextSecurePreferences.LANGUAGE_PREF)
                    .setOnPreferenceChangeListener(new LanguageSummaryListener());

            ListPreference langPreference = (ListPreference) this.findPreference(TextSecurePreferences.LANGUAGE_PREF);
...
//
//      if (GrapherexStore.paymentsValues().getPaymentsAvailability().showPaymentsMenu()) {
...
//                           dialog.dismiss();
//                           GrapherexStore.misc().hideUsernameReminder();
...
//          .setSummary(SmsMmsPreferenceFragment.getSummary(getActivity()));
            ...
            this.findPreference(PREFERENCE_CATEGORY_APPEARANCE)
                    .setSummary(AppearancePreferenceFragment.getThemeSummary(getActivity()));

            this.findPreference(TextSecurePreferences.LANGUAGE_PREF)
                    .setSummary(AppearancePreferenceFragment.getLanguageSummary(getActivity()));
...
//      return FeatureFlags.usernames() && !Recipient.self().getUsername().isPresent() && GrapherexStore.misc().shouldShowUsernameReminder();
//    }
...
//          break;
                    case PREFERENCE_CATEGORY_NOTIFICATIONS:
                        ...
                        break;
                    case PREFERENCE_CATEGORY_APP_PRIVACY:
...
//          break;
        ...
        private class LanguageSummaryListener implements Preference.OnPreferenceChangeListener {
            @Override
