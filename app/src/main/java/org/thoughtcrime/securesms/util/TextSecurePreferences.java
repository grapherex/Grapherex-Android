...
public class TextSecurePreferences {
    ...
    String getDeprecatedV1RegistrationLockPin(@NonNull Context context) {
        //noinspection deprecation
    ...
    public static @Nullable
    String getEncryptedBackupPassphrase(@NonNull Context context) {
    ...
    public static void setTheme(Context context, String value) {
        setStringPreference(context, THEME_PREF, value);
    }
