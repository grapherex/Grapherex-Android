...
import org.thoughtcrime.securesms.conversationlist.CallsHistoryFragment;
import org.thoughtcrime.securesms.conversationlist.CallsSelectContactFragment;
...
public class MainNavigator {
    ...
    public void goToCalls() {
        if (getFragmentManager().findFragmentById(R.id.fragment_container) instanceof CallsHistoryFragment) {
            return;
        }

        getFragmentManager().beginTransaction()
                .setCustomAnimations(R.anim.slide_from_end, R.anim.slide_to_start, R.anim.slide_from_start, R.anim.slide_to_end)
                .replace(R.id.fragment_container, new CallsHistoryFragment())
                .addToBackStack(null)
                .commit();
    }

    public void goToDialogs() {
        if (getFragmentManager().findFragmentById(R.id.fragment_container) instanceof ConversationListFragment) {
            return;
        }
        getFragmentManager().beginTransaction()
                .setCustomAnimations(R.anim.slide_from_end, R.anim.slide_to_start, R.anim.slide_from_start, R.anim.slide_to_end)
    ...
    public void goToCallsContacts() {
        if (getFragmentManager().findFragmentById(R.id.fragment_container) instanceof CallsSelectContactFragment) {
            return;
        }

        getFragmentManager().beginTransaction()
                .setCustomAnimations(R.anim.slide_from_end, R.anim.slide_to_start, R.anim.slide_from_start, R.anim.slide_to_end)
                .replace(R.id.fragment_container, new CallsSelectContactFragment())
                .addToBackStack(null)
                .commit();
    }
