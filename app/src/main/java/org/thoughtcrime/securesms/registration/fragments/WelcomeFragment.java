...
//            Manifest.permission.READ_PHONE_NUMBERS};
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        if (isReregister()) {
            ...
            continueButton = view.findViewById(R.id.btnRegistration);
            continueButton.setOnClickListener(this::continueClicked);

            view.findViewById(R.id.tvTerms).setOnClickListener(v -> onTermsClicked());
        }
    }
    ...
    private void continueClicked(@NonNull View view) {
        ...
        Permissions.with(this)
                ...
                .ifNecessary()
                .withRationaleDialog(getString(getContinueRationale(isUserSelectionRequired)), R.drawable.ic_contact_black_new)
...
//        } else {
    ...
    int getContinueRationale(boolean isUserSelectionRequired) {
