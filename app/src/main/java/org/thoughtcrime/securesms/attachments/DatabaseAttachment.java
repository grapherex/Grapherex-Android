...
public class DatabaseAttachment extends Attachment {
    ...
    public DatabaseAttachment(AttachmentId attachmentId,
                              ...
                              String bucket) {
        super(contentType, transferProgress, size, fileName, cdnNumber, location, key, relay, digest, fastPreflightId, voiceNote, borderless, width, height, quote, uploadTimestamp, credentionals, bucket, caption, stickerLocator, blurHash, audioHash, transformProperties);
