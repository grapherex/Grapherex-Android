...
final class MessageHeaderViewHolder extends RecyclerView.ViewHolder {
  ...
  private void bindMessageView(@NonNull LifecycleOwner lifecycleOwner, @Nullable ConversationMessage conversationMessage) {
    ...
    conversationItem.bind(lifecycleOwner, conversationMessage, Optional.absent(), Optional.absent(), glideRequests, Locale.getDefault(), new HashSet<>(),false, conversationMessage.getMessageRecord().getRecipient(), null, false, false, false);
  }
