...
class ContactDiscoveryV1 {
  ...
  static @NonNull
  DirectoryResult getDirectoryResult(@NonNull Set<String> databaseNumbers,
      ...
      throws IOException
  {
    ...
    return new DirectoryResult(uuids, outputResult.getRewrites(), null);
  }

  static @NonNull
  DirectoryResult getDirectoryResult(@NonNull String number) throws  IOException {
